...
- Create Angular project with ng: `ng new urlshortenerangular.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`urlshortenerangular.client.esproj`).
